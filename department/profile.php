    ...
    <body>
        <?php
           include("header.php");
            ...
            $ad=$_SESSION['dept'];
            $sql="SELECT * FROM department WHERE username='$ad'";
                            ...
                            <div class="row">
                                 <div class="col-md-6">
                                        ...
                                        <?php
                                            if(isset($_POST['update'])){
                                                ...
                                                if(empty($profile)){
                                                    ...
                                                    $sql="UPDATE dept SET profile='$profile' WHERE username='$ad'";
                                                    $result=mysqli_query($conn,$sql);
                                                    if($result){
                                        ...
                                        if(isset($_POST['change'])){
                                            ...
                                            if(empty($uname)){
                                                ...
                                                $sql="UPDATE department SET username='$uname' WHERE username='$ad'";
                                                    $result=mysqli_query($conn,$sql);
                                                    if($result){
                                                        $_SESSION['dept']=$uname;
                                                    }
                                 ...
                                 <?php
                                    if(isset($_POST['update_pass'])){
                                        ...
                                        $old=mysqli_query($conn,"select * from department where username='$ad' ");
                                        ...
                                        if(count($error)==0){
                                            $sql="UPDATE dept SET password='$new_pass' WHERE username='$ad'";
