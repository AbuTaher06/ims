            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    ...
                    if (isset($_SESSION['dept'])) {
                        $user = $_SESSION['dept'];
                        // Query to fetch profile picture URL from dept table based on username
                        // $query = "SELECT profile FROM department WHERE username = '$user'";
                       ...
                       // Output the dropdown menu with profile picture and username
                        ...
                        <img src="./img/default.png" alt="Profile Picture" style="width: 30px; height: 30px; border-radius: 50%; margin-right: 5px;">
                        '.$user.'
                      </a>';
