...
$sent_lists_query = "SELECT * FROM `exam_requests` WHERE sent_from_department = 'sent' AND reviewed_by_controller = 1 and sent_to_department = 'approved'";
...
<main id="main" class="main">
  <div class="pagetitle">
    <h1>Approved Exam Participation Lists</h1>
  </div><!-- End Page Title -->
